...
const ImageUploader: React.FC<ImageUploaderProps> = ({ id, className = "" }) => {
  ...
  return (
    <div className={`relative group shrink-0 ${className}`}>
      ...
      {isLoading ? (
         <div className="w-16 h-16 bg-zinc-950 rounded-lg border border-zinc-800 flex items-center justify-center">
        ...
        <div className="relative w-16 h-16 rounded-lg overflow-hidden border border-zinc-700 cursor-pointer" onClick={triggerUpload}>
        ...
        <button
          ...
          className="w-16 h-16 bg-zinc-950 hover:bg-zinc-900 border border-zinc-800 border-dashed hover:border-zinc-600 rounded-lg flex flex-col items-center justify-center gap-1 transition-all group"
          title="Upload Image"
        >
